...
int main() {
    ...
    // lorae5.setKey(NULL, NULL, (char*)LoRa_APPKEY); /*Only App key is seeted when using OOTA*/
    ...
    lorae5.initP2PModeTX(868, SF12, BW125, 12, 15, LoRa_POWER);

    while (1) {
        // lorae5.setDeviceWakeUp();

        lorae5.transferPacketP2PMode((unsigned char *) buffer_char, 5);
