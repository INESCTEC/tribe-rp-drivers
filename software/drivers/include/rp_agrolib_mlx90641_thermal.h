...
#ifndef rp_agrolib_mlx90641_thermal_h
#define rp_agrolib_mlx90641_thermal_h
...
#define I2C_ADDR 0x33                  // I2C bit address of the MLX90641
...
#define SAMPLE_DELAY 150                    // delay between reading samples (see setRefreshRate() table)
...
#define CTRL_ADDR 0x800D                  // Address for Control Register
#define CAL_INT -120.52           // Intercept of T_meas vs. T_o calibration curve (post-hoc calibration). My value: -45.4209807273067 
#define CAL_SLOPE 5.2935      // Slope of T_meas vs. T_o calibration curve (post-hoc calibration). My value: 2.64896693658985 
...
class MLX90641 {
    ...
    void printFrame(float *Tdat, float Tamb); // To print temperature pixel frame to serial monitor
